...
describe('InMemoryStorage', () => {
    ...
    describe('Client operations', () => {
        ...
        it('should throw error when updating non-existent client', async () => {
            ...
            await expect(storage.updateClient('non-existent', updatedClient)).rejects.toThrow('Client with id non-existent not found');
        });
    ...
    describe('Reservation operations', () => {
        ...
        it('should update an existing reservation', async () => {
            ...
            const retrieved = await storage.getReservation('reservation-1');
            expect(retrieved?.status).toBe(Reservation_1.ReservationStatus.CONFIRMED);
        });
        it('should throw error when updating non-existent reservation', async () => {
            ...
            await expect(storage.updateReservation('non-existent', updatedReservation)).rejects.toThrow('Reservation with id non-existent not found');
        });
    ...
    describe('Property operations', () => {
        ...
        it('should throw error when updating non-existent property', async () => {
            ...
            await expect(storage.updateProperty('non-existent', updatedProperty)).rejects.toThrow('Property with id non-existent not found');
        });
